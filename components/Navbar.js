...
const Navbar = () => {
  ...
  return (
    <div style={{ backgroundColor: `${color}` }} className="fixed w-full z-10 left-0 top-0 ease-in duration-300">
      <div className="max-w-[1240px] flex justify-between text-white p-4 mx-auto items-center">
        <Link href="/">
          <h1 style={{ color: `${textColor}` }} className="text-4xl font-bold">Unique.</h1>
        </Link>
